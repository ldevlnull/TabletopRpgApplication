    ...
    <div>
        ...
        <div class="table-responsive" v-if="gameSystems && gameSystems.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('trpgPlanningApplicationApp.gameSystem.pictureURL')">Picture</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity">
            ...
            <div class="modal-body">
                <p id="jhi-delete-gameSystem-heading" v-text="$t('trpgPlanningApplicationApp.gameSystem.delete.question', {'id': removeId})">Are you sure you want to delete this
                    Game System?</p>
            </div>
