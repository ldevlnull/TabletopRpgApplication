...
@Component
export default class Character extends mixins(Vue2Filters.mixin, AlertMixin) {
  ...
  public removeCharacter(): void {
    this.characterService()
      ...
      .then(() => {
        const message = this.$t('trpgPlanningApplicationApp.character.deleted', { param: this.removeId });
