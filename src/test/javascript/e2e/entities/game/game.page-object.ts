...
export default class GameComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('game-heading'));
...
export class GameDeleteDialog {
  ...
  title: ElementFinder = element(by.id('trpgPlanningApplicationApp.game.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-game'));
}
