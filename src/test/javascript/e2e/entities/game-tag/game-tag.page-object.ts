...
export default class GameTagComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('game-tag-heading'));
...
export class GameTagDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('trpgPlanningApplicationApp.gameTag.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-gameTag'));
}
