...
export default class CharacterComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('character-heading'));
...
export class CharacterDeleteDialog {
  ...
  title: ElementFinder = element(by.id('trpgPlanningApplicationApp.character.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-character'));
}
